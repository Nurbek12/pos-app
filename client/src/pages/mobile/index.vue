                ...
                <v-card flat class="mt-2">
                            ...
                            <template v-for="c in store.getCart" :key="c.id">
                                <v-list-item class="px-0">
                                    ...
                                    <v-list-item-subtitle>
                                        ...
                                        <template #append>
                                            <div class="d-flex align-center justify-space-between ga-3" v-if="store.getCart.some(cr => cr.id === c.id)">
                                                <v-btn size="37" @click="store.removeFromCart(c)" color="primary" variant="flat">
                                                    <v-icon>mdi-minus</v-icon>
                                                </v-btn>
                                                ...
                                                <v-btn size="37" @click="store.addToCart(c)" color="primary" variant="flat">
                                                    <v-icon>mdi-plus</v-icon>
                                                </v-btn>
                                            </div>
                                        </template>
                    ...
                    <v-card-text class="pt-0">
                        ...
                        <div class="d-flex ga-2 w-100 mt-4">
                            ...
                            <v-btn height="45" @click="handleCreateOrder" :disabled="store.getCart.length<=0||!address" color="primary" variant="flat" style="flex: 1">
                                Yaratish
                            </v-btn>
                        </div>
                    </v-card-text>
